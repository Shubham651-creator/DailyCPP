...
#Implement below listed functions:
...
vi) Search Flight details by Flight number.Display appropriate message if not found.

vii) Modify flight details by flight number.